...
L_button_proc235:
;main.c,263 :: 		if (bypas==0 & type!=0) {   // long press button
	MOVF       _bypas+0, 0
	XORLW      0
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,270 :: 		led_wr_str (2, 16, "SWR=0.00", 8);
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,271 :: 		if(L==1) led_wr_str (0, 16+8*12, "l", 1); else led_wr_str (0, 16+8*12, "c", 1);
	MOVF       _L+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
...
;main.c,278 :: 		led_wr_str (1, 0, "SWR=0.00", 8);
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,279 :: 		if(L==1) led_wr_str (0, 8, "l", 1); else led_wr_str (0, 8, "c", 1);
	MOVF       _L+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
...
L_button_proc266:
;main.c,310 :: 		if(type!=0) user_setup();
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
...
;main.c,396 :: 		led_wr_str (0, 8, " ATU-100 ", 9);
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,397 :: 		led_wr_str (2, 16, "7x7 v3.3", 8);
	MOVLW      2
	MOVWF      FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
...
;main.c,417 :: 		if(lcd_prep_short==0) {
	...
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_prep311
;main.c,418 :: 		led_wr_str (0, 0, "ATU-100 7x7 v3.3", 16);
	CLRF       FARG_led_wr_str+0
	CLRF       FARG_led_wr_str+0
	MOVLW      ?lstr47_main+0
	MOVWF      FARG_led_wr_str+0
...
;main.c,708 :: 		if(ind.B6) work_int += Ind7;
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind428:
;main.c,709 :: 		if(work_int>9999) {    // more then 9999 nH
	MOVLW      128
	XORLW      39
	MOVWF      R0
	MOVLW      128
...
;main.c,711 :: 		IntToStr(work_int, work_str);
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,712 :: 		work_str_2[0] = work_str[1];
	MOVF       _work_str+1, 0
	MOVWF      _work_str_2+0
;main.c,713 :: 		work_str_2[1] = work_str[2];
	MOVF       _work_str+2, 0
	MOVWF      _work_str_2+1
;main.c,714 :: 		work_str_2[2] = '.';
	MOVLW      46
	MOVWF      _work_str_2+2
;main.c,715 :: 		work_str_2[3] = work_str[3];
	MOVF       _work_str+3, 0
	MOVWF      _work_str_2+3
;main.c,716 :: 		}
	GOTO       L_lcd_ind430
L_lcd_ind429:
;main.c,718 :: 		IntToStr(work_int, work_str);
	MOVF       _work_int+0, 0
	MOVWF      FARG_IntToStr_input+0
	MOVF       _work_int+1, 0
	MOVWF      FARG_IntToStr_input+1
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,719 :: 		if(work_str[2] != ' ') work_str_2[0] = work_str[2]; else work_str_2[0] = '0';
	MOVF       _work_str+2, 0
	XORLW      32
	BTFSC      STATUS+0, 2
	GOTO       L_lcd_ind431
...
L_lcd_ind431:
	...
	MOVWF      _work_str_2+0
L_lcd_ind432:
;main.c,720 :: 		work_str_2[1] = '.';
	MOVLW      46
	MOVWF      _work_str_2+1
;main.c,721 :: 		if(work_str[3] != ' ') work_str_2[2] = work_str[3]; else work_str_2[2] = '0';
	MOVF       _work_str+3, 0
	XORLW      32
	BTFSC      STATUS+0, 2
	GOTO       L_lcd_ind433
...
L_lcd_ind433:
	...
	MOVWF      _work_str_2+2
L_lcd_ind434:
;main.c,722 :: 		if(work_str[4] != ' ') work_str_2[3] = work_str[4]; else work_str_2[3] = '0';
	MOVF       _work_str+4, 0
	XORLW      32
	BTFSC      STATUS+0, 2
	GOTO       L_lcd_ind435
...
;main.c,723 :: 		}
L_lcd_ind430:
;main.c,724 :: 		if(type==4 | type==5) {  // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,735 :: 		}
	GOTO       L_lcd_ind444
L_lcd_ind441:
;main.c,736 :: 		else if(type==1) { //  1602 LCD
	MOVF       _type+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind445
;main.c,737 :: 		if(SW==1) column = 0; else column = 1;
	MOVF       main_SW+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind446
...
L_lcd_ind446:
	...
	MOVWF      lcd_ind_column_L0+0
L_lcd_ind447:
;main.c,738 :: 		led_wr_str (column, 9, "L=", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      9
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,739 :: 		led_wr_str (column, 15, "u", 1);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      15
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,740 :: 		led_wr_str (column, 11, work_str_2, 4);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      11
	MOVWF      FARG_led_wr_str+0
...
L_lcd_ind444:
L_lcd_ind440:
;main.c,743 :: 		asm CLRWDT;
	CLRWDT
;main.c,745 :: 		work_int = 0;
	CLRF       _work_int+0
	CLRF       _work_int+1
;main.c,746 :: 		if(cap.B0) work_int += Cap1;
	BTFSS      main_cap+0, 0
	GOTO       L_lcd_ind449
	MOVF       _Cap1+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind449:
;main.c,747 :: 		if(cap.B1) work_int += Cap2;
	BTFSS      main_cap+0, 1
	GOTO       L_lcd_ind450
	MOVF       _Cap2+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind450:
;main.c,748 :: 		if(cap.B2) work_int += Cap3;
	BTFSS      main_cap+0, 2
	GOTO       L_lcd_ind451
	MOVF       _Cap3+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind451:
;main.c,749 :: 		if(cap.B3) work_int += Cap4;
	BTFSS      main_cap+0, 3
	GOTO       L_lcd_ind452
	MOVF       _Cap4+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind452:
;main.c,750 :: 		if(cap.B4) work_int += Cap5;
	BTFSS      main_cap+0, 4
	GOTO       L_lcd_ind453
	MOVF       _Cap5+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind453:
;main.c,751 :: 		if(cap.B5) work_int += Cap6;
	BTFSS      main_cap+0, 5
	GOTO       L_lcd_ind454
	MOVF       _Cap6+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind454:
;main.c,752 :: 		if(cap.B6) work_int += Cap7;
	BTFSS      main_cap+0, 6
	GOTO       L_lcd_ind455
	MOVF       _Cap7+0, 0
	ADDWF      _work_int+0, 1
	...
	ADDWFC     _work_int+1, 1
L_lcd_ind455:
;main.c,753 :: 		IntToStr(work_int, work_str);
	MOVF       _work_int+0, 0
	MOVWF      FARG_IntToStr_input+0
	MOVF       _work_int+1, 0
	MOVWF      FARG_IntToStr_input+1
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,754 :: 		work_str_2[0] = work_str[2];
	MOVF       _work_str+2, 0
	MOVWF      _work_str_2+0
;main.c,755 :: 		work_str_2[1] = work_str[3];
	MOVF       _work_str+3, 0
	MOVWF      _work_str_2+1
;main.c,756 :: 		work_str_2[2] = work_str[4];
	MOVF       _work_str+4, 0
	MOVWF      _work_str_2+2
;main.c,757 :: 		work_str_2[3] = work_str[5];
	MOVF       _work_str+5, 0
	MOVWF      _work_str_2+3
;main.c,759 :: 		if(type==4 | type==5) {  // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
	...
	BTFSC      STATUS+0, 2
	GOTO       L_lcd_ind456
;main.c,760 :: 		if(SW==1) column = 6; else column = 4;
	MOVF       main_SW+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind457
...
L_lcd_ind457:
	...
	MOVWF      lcd_ind_column_L0+0
L_lcd_ind458:
;main.c,761 :: 		led_wr_str (column, 16, "C=", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,762 :: 		led_wr_str (column, 16+6*12, "pF", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      88
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,763 :: 		led_wr_str (column, 16+2*12, work_str_2, 4);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      40
	MOVWF      FARG_led_wr_str+0
...
;main.c,764 :: 		}
	GOTO       L_lcd_ind459
L_lcd_ind456:
;main.c,765 :: 		else if(type==2 | type==3) {// 128*32 OLED
	MOVF       _type+0, 0
	XORLW      2
	MOVLW      1
	BTFSS      STATUS+0, 2
	...
	BTFSC      STATUS+0, 2
	GOTO       L_lcd_ind460
;main.c,766 :: 		if(SW==1) column = 1; else column = 0;
	MOVF       main_SW+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind461
...
L_lcd_ind461:
	CLRF       lcd_ind_column_L0+0
L_lcd_ind462:
;main.c,767 :: 		led_wr_str (column, 9, "C=", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      9
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,768 :: 		led_wr_str (column, 15, "pF", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      15
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,769 :: 		led_wr_str (column, 11, work_str_2, 4);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      11
	MOVWF      FARG_led_wr_str+0
...
;main.c,770 :: 		}
	GOTO       L_lcd_ind463
L_lcd_ind460:
;main.c,771 :: 		else if(type==1) { // 1602 LCD
	MOVF       _type+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind464
;main.c,772 :: 		if(SW==1) column = 1; else column = 0;
	MOVF       main_SW+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_lcd_ind465
...
L_lcd_ind465:
	CLRF       lcd_ind_column_L0+0
L_lcd_ind466:
;main.c,773 :: 		led_wr_str (column, 9, "C=", 2);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      9
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,774 :: 		led_wr_str (column, 15, "p", 1);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      15
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,775 :: 		led_wr_str (column, 11, work_str_2, 4);
	MOVF       lcd_ind_column_L0+0, 0
	MOVWF      FARG_led_wr_str+0
	MOVLW      11
	MOVWF      FARG_led_wr_str+0
...
;main.c,829 :: 		void user_setup()  {
;main.c,832 :: 		usr_set = 1;
	MOVLW      1
...
;main.c,833 :: 		asm CLRWDT;
	CLRWDT
;main.c,834 :: 		dysp_on();          // dysplay ON
	CALL       _dysp_on+0
;main.c,835 :: 		if(type==4 | type==5) {    // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
L_user_setup468:
;main.c,844 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup471
;main.c,845 :: 		led_wr_str (0, 0, "                 ", 17);
	CLRF       FARG_led_wr_str+0
	CLRF       FARG_led_wr_str+0
	MOVLW      ?lstr97_main+0
	MOVWF      FARG_led_wr_str+0
...
;main.c,859 :: 		asm CLRWDT;
	CLRWDT
;main.c,860 :: 		if(usr_set == 1) {   // min SWR setup
	MOVLW      0
	XORWF      user_setup_usr_set_L0+1, 0
	BTFSS      STATUS+0, 2
...
;main.c,861 :: 		inttostr((Auto_delta / 10), swr_str);
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,862 :: 		if(type==4 | type==5) {    // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,863 :: 		led_wr_str(0, 16, "Min SWR  ", 9);
	CLRF       FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
	MOVLW      ?lstr99_main+0
...
;main.c,864 :: 		asm CLRWDT;
	CLRWDT
;main.c,865 :: 		led_wr_str(3, 6, swr_str, 6);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      6
	MOVWF      FARG_led_wr_str+0
...
L_user_setup476:
;main.c,870 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup479
;main.c,871 :: 		led_wr_str(0, 1, "Min SWR  ", 9);
	CLRF       FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,872 :: 		led_wr_str(1, 1, SWR_str, 6);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
...
L_user_setup479:
L_user_setup478:
;main.c,876 :: 		if(Button(&PORTB, 2, 50, 0)){   // BYP button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,877 :: 		asm CLRWDT;
	CLRWDT
;main.c,878 :: 		if(Auto_delta < 190) {
	MOVLW      128
	XORWF      _Auto_delta+1, 0
	MOVWF      R0
	MOVLW      128
...
;main.c,879 :: 		Auto_delta = Auto_delta + 10;
	MOVLW      10
...
L_user_setup483:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup483
;main.c,882 :: 		asm CLRWDT;
	CLRWDT
;main.c,883 :: 		} // end of BYP button
L_user_setup481:
;main.c,884 :: 		if(Button(&PORTB, 1, 50, 0)){   // Auto button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,887 :: 		Auto_delta = Auto_delta - 10;
	MOVLW      10
...
;main.c,891 :: 		}
L_user_setup484:
;main.c,892 :: 		} // end min SWR setup
L_user_setup475:
;main.c,893 :: 		if(usr_set == 2) {   // max PWR setup
	MOVLW      0
	XORWF      user_setup_usr_set_L0+1, 0
	BTFSS      STATUS+0, 2
...
;main.c,894 :: 		inttostr((max_for_start / 10), swr_str);
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,895 :: 		if(type==4 | type==5) {    // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,896 :: 		led_wr_str(0, 16, "Max PWR", 7);
	CLRF       FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
...
;main.c,897 :: 		asm CLRWDT;
	CLRWDT
;main.c,898 :: 		led_wr_str(3, 6, swr_str, 6);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      6
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,899 :: 		asm CLRWDT;
	CLRWDT
;main.c,900 :: 		delay_ms(100);
	MOVLW      3
	MOVWF      R11
	MOVLW      8
	MOVWF      R12
...
L_user_setup488:
;main.c,903 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup491
;main.c,904 :: 		led_wr_str(0, 1, "Max PWR", 7);
	CLRF       FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,905 :: 		led_wr_str(1, 1, SWR_str, 6);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
...
L_user_setup491:
L_user_setup490:
;main.c,909 :: 		if(Button(&PORTB, 2, 50, 0)){   // BYP button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,910 :: 		asm CLRWDT;
	CLRWDT
;main.c,911 :: 		if(max_for_start < 900) {
	MOVLW      128
	XORWF      main_max_for_start+1, 0
	MOVWF      R0
	MOVLW      128
...
;main.c,912 :: 		max_for_start = max_for_start + 100;
	MOVLW      100
...
;main.c,915 :: 		asm CLRWDT;
	CLRWDT
;main.c,916 :: 		} // end of BYP button
L_user_setup493:
;main.c,917 :: 		if(Button(&PORTB, 1, 50, 0)){   // Auto button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,918 :: 		asm CLRWDT;
	CLRWDT
;main.c,919 :: 		if(max_for_start > 0) {
	MOVLW      128
	MOVWF      R0
	MOVLW      128
	XORWF      main_max_for_start+1, 0
...
;main.c,920 :: 		max_for_start = max_for_start - 100;
	MOVLW      100
...
L_user_setup498:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup498
;main.c,923 :: 		asm CLRWDT;
	CLRWDT
;main.c,924 :: 		}
L_user_setup496:
;main.c,925 :: 		} // end max PWR setup
L_user_setup487:
;main.c,926 :: 		if(usr_set == 5) {   // clear screen delay
	MOVLW      0
	XORWF      user_setup_usr_set_L0+1, 0
	BTFSS      STATUS+0, 2
...
;main.c,927 :: 		inttostr(Dysp_delay, swr_str);
	MOVF       _Dysp_delay+0, 0
	MOVWF      FARG_IntToStr_input+0
...
;main.c,929 :: 		led_wr_str(0, 16, "ScrDel ", 7);
	CLRF       FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
...
;main.c,930 :: 		asm CLRWDT;
	CLRWDT
;main.c,931 :: 		led_wr_str(3, 6, swr_str, 7);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      6
	MOVWF      FARG_led_wr_str+0
...
L_user_setup500:
;main.c,936 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup503
;main.c,937 :: 		led_wr_str(0, 1, "ScrDel ", 7);
	CLRF       FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,938 :: 		led_wr_str(1, 1, SWR_str, 6);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,939 :: 		asm CLRWDT;
	CLRWDT
;main.c,940 :: 		Delay_ms(100);
	MOVLW      3
	MOVWF      R11
	MOVLW      8
	MOVWF      R12
...
L_user_setup503:
L_user_setup502:
;main.c,942 :: 		if(Button(&PORTB, 2, 50, 0)){   // BYP button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,943 :: 		asm CLRWDT;
	CLRWDT
;main.c,944 :: 		if(Dysp_delay < 90) {
	MOVLW      90
	SUBWF      _Dysp_delay+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L_user_setup506
;main.c,945 :: 		Dysp_delay = Dysp_delay + 10;
	MOVLW      10
...
;main.c,948 :: 		asm CLRWDT;
	CLRWDT
;main.c,949 :: 		} // end of BYP button
L_user_setup505:
;main.c,950 :: 		if(Button(&PORTB, 1, 50, 0)){   // Auto button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,951 :: 		asm CLRWDT;
	CLRWDT
;main.c,952 :: 		if(Dysp_delay > 0) {
	MOVF       _Dysp_delay+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L_user_setup509
;main.c,953 :: 		Dysp_delay = Dysp_delay - 10;
	MOVLW      10
	SUBWF      _Dysp_delay+0, 0
	MOVWF      R1
	MOVF       R1, 0
	MOVWF      _Dysp_delay+0
;main.c,954 :: 		if (Dysp_delay < 10)
	MOVLW      10
	SUBWF      R1, 0
	BTFSC      STATUS+0, 0
	GOTO       L_user_setup510
;main.c,955 :: 		Dysp_delay = 0;
	CLRF       _Dysp_delay+0
L_user_setup510:
;main.c,956 :: 		}
L_user_setup509:
;main.c,957 :: 		Delay_ms(30);
	MOVLW      156
	MOVWF      R12
	MOVLW      215
	MOVWF      R13
...
;main.c,959 :: 		}
L_user_setup508:
;main.c,960 :: 		} // end clear screen delay setup
L_user_setup499:
;main.c,961 :: 		if(usr_set == 4) {   // losses setup
	MOVLW      0
	XORWF      user_setup_usr_set_L0+1, 0
	BTFSS      STATUS+0, 2
...
;main.c,962 :: 		inttostr(Fid_loss, swr_str);
	MOVF       _Fid_loss+0, 0
	MOVWF      FARG_IntToStr_input+0
	CLRF       FARG_IntToStr_input+1
	MOVLW      user_setup_SWR_str_L0+0
	...
	MOVWF      FARG_IntToStr_output+1
	CALL       _IntToStr+0
;main.c,963 :: 		if(type==4 | type==5) {    // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,964 :: 		led_wr_str(0, 16, "Losses  ", 8);
	CLRF       FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,966 :: 		led_wr_str(3, 6, swr_str, 7);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      6
	MOVWF      FARG_led_wr_str+0
...
L_user_setup513:
;main.c,971 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup516
;main.c,972 :: 		led_wr_str(0, 1, "Losses  ", 8);
	CLRF       FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,973 :: 		led_wr_str(1, 1, SWR_str, 6);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,974 :: 		asm CLRWDT;
	CLRWDT
;main.c,975 :: 		Delay_ms(100);
	MOVLW      3
	MOVWF      R11
	MOVLW      8
	MOVWF      R12
...
L_user_setup516:
L_user_setup515:
;main.c,977 :: 		if(Button(&PORTB, 2, 50, 0)){   // BYP button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,978 :: 		asm CLRWDT;
	CLRWDT
;main.c,979 :: 		if(Fid_loss < 99) {
	MOVLW      99
	SUBWF      _Fid_loss+0, 0
	BTFSC      STATUS+0, 0
	GOTO       L_user_setup519
;main.c,980 :: 		Fid_loss = Fid_loss + 1;
	INCF       _Fid_loss+0, 1
;main.c,981 :: 		}
L_user_setup519:
;main.c,982 :: 		Delay_ms(30);
	MOVLW      156
	MOVWF      R12
	MOVLW      215
	MOVWF      R13
L_user_setup520:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup520
;main.c,983 :: 		asm CLRWDT;
	CLRWDT
;main.c,984 :: 		} // end of BYP button
L_user_setup518:
;main.c,985 :: 		if(Button(&PORTB, 1, 50, 0)){   // Auto button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,986 :: 		asm CLRWDT;
	CLRWDT
;main.c,987 :: 		if(Fid_loss > 0) {
	MOVF       _Fid_loss+0, 0
	SUBLW      0
	BTFSC      STATUS+0, 0
	GOTO       L_user_setup522
;main.c,988 :: 		Fid_loss = Fid_loss - 1;
	DECF       _Fid_loss+0, 1
;main.c,989 :: 		}
L_user_setup522:
;main.c,990 :: 		Delay_ms(30);
	MOVLW      156
	MOVWF      R12
	MOVLW      215
	MOVWF      R13
L_user_setup523:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup523
;main.c,991 :: 		asm CLRWDT;
	CLRWDT
;main.c,992 :: 		}
L_user_setup521:
;main.c,993 :: 		} // end losses setup
L_user_setup512:
;main.c,995 :: 		if(usr_set == 3) {   // loss mode
	MOVLW      0
	XORWF      user_setup_usr_set_L0+1, 0
	BTFSS      STATUS+0, 2
...
;main.c,996 :: 		if(type==4 | type==5) {    // 128*64 OLED
	MOVF       _type+0, 0
	XORLW      4
	MOVLW      1
	BTFSS      STATUS+0, 2
...
;main.c,997 :: 		led_wr_str(0, 16, "Loss ind", 8);
	CLRF       FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,999 :: 		if (Loss_ind == 1)
	MOVF       main_Loss_ind+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_user_setup526
;main.c,1000 :: 		led_wr_str(3, 16, "   ON  ", 7);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
...
L_user_setup526:
;main.c,1002 :: 		led_wr_str(3, 16, "   OFF ", 7);
	MOVLW      3
	MOVWF      FARG_led_wr_str+0
	MOVLW      16
	MOVWF      FARG_led_wr_str+0
...
L_user_setup528:
	...
	DECFSZ     R11, 1
	GOTO       L_user_setup528
;main.c,1004 :: 		asm CLRWDT;
	CLRWDT
;main.c,1005 :: 		}
	GOTO       L_user_setup529
L_user_setup525:
;main.c,1006 :: 		else if(type!=0) {   // 1602 LCD & 128*32 OLED
	MOVF       _type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_user_setup530
;main.c,1007 :: 		led_wr_str(0, 1, "Loss ind", 8);
	CLRF       FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	MOVWF      FARG_led_wr_str+0
	CALL       _led_wr_str+0
;main.c,1008 :: 		if (Loss_ind == 1)
	MOVF       main_Loss_ind+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_user_setup531
;main.c,1009 :: 		led_wr_str(1, 1, "   ON  ", 7);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
...
L_user_setup531:
;main.c,1011 :: 		led_wr_str(1, 1, "   OFF ", 7);
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	MOVLW      1
	MOVWF      FARG_led_wr_str+0
	...
	CALL       _led_wr_str+0
L_user_setup532:
;main.c,1012 :: 		asm CLRWDT;
	CLRWDT
;main.c,1013 :: 		Delay_ms(100);
	MOVLW      3
	MOVWF      R11
	MOVLW      8
	MOVWF      R12
...
L_user_setup530:
L_user_setup529:
;main.c,1015 :: 		if(Button(&PORTB, 2, 50, 0)){   // BYP button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,1016 :: 		asm CLRWDT;
	CLRWDT
;main.c,1017 :: 		if(Loss_ind == 0) {
	MOVF       main_Loss_ind+0, 0
	XORLW      0
	BTFSS      STATUS+0, 2
	GOTO       L_user_setup535
;main.c,1018 :: 		Loss_ind = 1;
	MOVLW      1
	MOVWF      main_Loss_ind+0
;main.c,1019 :: 		}
L_user_setup535:
;main.c,1020 :: 		Delay_ms(30);
	MOVLW      156
	MOVWF      R12
	MOVLW      215
	MOVWF      R13
L_user_setup536:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup536
;main.c,1021 :: 		asm CLRWDT;
	CLRWDT
;main.c,1022 :: 		} // end of BYP button
L_user_setup534:
;main.c,1023 :: 		if(Button(&PORTB, 1, 50, 0)){   // Auto button
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,1024 :: 		asm CLRWDT;
	CLRWDT
;main.c,1025 :: 		if(Loss_ind == 1) {
	MOVF       main_Loss_ind+0, 0
	XORLW      1
	BTFSS      STATUS+0, 2
	GOTO       L_user_setup538
;main.c,1026 :: 		Loss_ind = 0;
	CLRF       main_Loss_ind+0
;main.c,1027 :: 		}
L_user_setup538:
;main.c,1028 :: 		Delay_ms(30);
	MOVLW      156
	MOVWF      R12
	MOVLW      215
	MOVWF      R13
L_user_setup539:
	...
	DECFSZ     R12, 1
	GOTO       L_user_setup539
;main.c,1029 :: 		asm CLRWDT;
	CLRWDT
;main.c,1030 :: 		}
L_user_setup537:
;main.c,1031 :: 		} // end lose mode setup
L_user_setup524:
;main.c,1033 :: 		if(Button(&PORTB, 0, 50, 0)){    // Tune btn
	MOVLW      PORTB+0
	MOVWF      FARG_Button_port+0
	MOVLW      hi_addr(PORTB+0)
	MOVWF      FARG_Button_port+1
...
;main.c,1035 :: 		asm CLRWDT;
	CLRWDT
;main.c,1036 :: 		if(PORTB.B0==1) { // short press button
	BTFSS      PORTB+0, 0
...
;main.c,1042 :: 		asm CLRWDT;
	CLRWDT
;main.c,1043 :: 		usr_set = 0; // exit setup
	CLRF       user_setup_usr_set_L0+0
	CLRF       user_setup_usr_set_L0+1
;main.c,1044 :: 		}
L_user_setup544:
;main.c,1045 :: 		asm CLRWDT;
	CLRWDT
;main.c,1046 :: 		}  // END Tune btn
L_user_setup540:
;main.c,1048 :: 		}
	GOTO       L_user_setup473
L_user_setup474:
;main.c,1050 :: 		EEPROM_Write(4, dec2bcd(Auto_delta / 10));
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_EEPROM_Write_Address+0
	CALL       _EEPROM_Write+0
;main.c,1051 :: 		EEPROM_Write(6, dec2bcd(max_for_start / 10));
	MOVLW      10
	MOVWF      R4
	MOVLW      0
	MOVWF      R5
	...
	MOVWF      FARG_EEPROM_Write_Address+0
	CALL       _EEPROM_Write+0
;main.c,1052 :: 		EEPROM_Write(50, dec2bcd(Dysp_delay));
	MOVF       _Dysp_delay+0, 0
	MOVWF      FARG_Dec2Bcd_decnum+0
	CALL       _Dec2Bcd+0
	MOVF       R0, 0
	...
	MOVWF      FARG_EEPROM_Write_Address+0
	CALL       _EEPROM_Write+0
;main.c,1053 :: 		EEPROM_Write(0x34, dec2bcd(Fid_loss));
	MOVF       _Fid_loss+0, 0
	MOVWF      FARG_Dec2Bcd_decnum+0
	CALL       _Dec2Bcd+0
	MOVF       R0, 0
	...
	MOVWF      FARG_EEPROM_Write_Address+0
	CALL       _EEPROM_Write+0
;main.c,1054 :: 		EEPROM_Write(0x33, dec2bcd(Loss_ind));
	MOVF       main_Loss_ind+0, 0
	MOVWF      FARG_Dec2Bcd_decnum+0
	CALL       _Dec2Bcd+0
	MOVF       R0, 0
	...
	MOVWF      FARG_EEPROM_Write_Address+0
	CALL       _EEPROM_Write+0
;main.c,1055 :: 		dysp_cnt = Dysp_delay * dysp_cnt_mult;
	MOVF       _Dysp_delay+0, 0
	MOVWF      R0
	CALL       _Byte2Double+0
	MOVF       _dysp_cnt_mult+0, 0
	...
	MOVF       R1, 0
	MOVWF      _dysp_cnt+1
;main.c,1057 :: 		asm CLRWDT;
	CLRWDT
;main.c,1058 :: 		lcd_prep_short = 1;
	MOVLW      1
	MOVWF      _lcd_prep_short+0
;main.c,1060 :: 		lcd_prep();
	CALL       _lcd_prep+0
;main.c,1061 :: 		delay_ms(500);
	MOVLW      11
	MOVWF      R11
	MOVLW      38
	MOVWF      R12
